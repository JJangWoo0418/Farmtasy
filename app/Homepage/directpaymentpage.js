                ...
                <View style={styles.container}>
                    ...
                    <View style={styles.inputWrapper}>
                        <TextInput
                            ...
                            placeholder="숫자만 입력해 주세요 (예: 5,000)"
                        />
                    ...
                    <View style={styles.toggleRow}>
                        <TouchableOpacity
                            style={[
                                styles.toggleBtn,
                                landType === '논' && styles.toggleBtnActive
                            ]}
                        ...
                        <TouchableOpacity
                            style={[
                                styles.toggleBtn,
                                { marginRight: 0 }, // 마지막 버튼만 오른쪽 여백 제거
                                landType === '밭' && styles.toggleBtnActive
                            ]}
                    ...
                    <View style={styles.toggleRow}>
                        <TouchableOpacity
                            style={[
                                styles.toggleBtn,
                                regionType === '진흥지역' && styles.toggleBtnActive
                            ]}
                        ...
                        <TouchableOpacity
                            style={[
                                styles.toggleBtn,
                                { marginRight: 0 }, // 마지막 버튼만 오른쪽 여백 제거
                                regionType === '비진흥지역' && styles.toggleBtnActive
                            ]}
